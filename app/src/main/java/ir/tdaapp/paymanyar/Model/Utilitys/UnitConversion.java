...
//                answer.add("FeetOfSeaWater");
                answer.add("ft H2O 4C");
                answer.add("ft H2O 60F");
...
//                answer.add("Hectopascals");
                answer.add("InHG 32F");
                answer.add("InHG 60F");
                answer.add("in H2O 4C");
                answer.add("in H2O 60F");
//                answer.add("KSI");
                answer.add("KG/cm2");
...
//                answer.add("LeapYears");
                answer.add("Microsecond");
//                answer.add("Millenniums");
                answer.add("Millisecond");
                answer.add("Minute");
                answer.add("Month");
                answer.add("Nanosecond");
...
//                answer.add("Tuns");
    ...
    private String Density(String value, String value_unit, String answer_unit) {
    ...
    private BigDecimal getValDensity(String value) {
        ...
        switch (value) {
            ...
            case "kg/m3":
                ...
                break;
            case "gr/gal":
                val = "3.78541075733872";
                break;
            case "lb/in3":
                val = "0.0000361272993783422";
                break;
            case "lb/ft3":
                val = "0.0624279737253144000";
                break;
            case "lb/gal":
                val = "0.0083454089843842700";
                break;
            case "lb/bbl":
                val = "0.3505071024305710000";
                break;
            case "oz/in3":
                val = "0.0005780367775678810";
                break;
            case "oz/gal":
                val = "0.1335265062933640000";
                break;
        }
