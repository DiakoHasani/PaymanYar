            ...
            if (resault.getResault() == ResaultCode.Success) {
              ...
              for (int i = 0; i < array.length(); i++) {
                try {
                  ...
                  supplyNetwork.setActive(object.getBoolean("IsActive"));
            ...
            try {
              ...
              for (int i = 0; i < array.length(); i++) {
                ...
                try {
                  ...
                  machinery.setActive(object.getBoolean("IsActive"));
          ...
          if (resault.getResault() == ResaultCode.Success) {
            ...
            for (int i = 0; i < array.length(); i++) {
              ...
              try {
                ...
                //فعال بودن آگهی
                material.setActive(object.getBoolean("IsActive"));
