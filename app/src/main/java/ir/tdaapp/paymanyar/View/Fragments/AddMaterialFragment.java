...
import ir.tdaapp.paymanyar.Presenter.P_AddMaterialFragment;
...
/**
 * مربوط به صفحه افزودن مصالح
 **/
public class AddMaterialFragment extends BaseFragment implements S_AddMaterialFragment, View.OnClickListener {

    public static final String TAG = "AddMaterialFragment";
    P_AddMaterialFragment p_addMaterialFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.add_material_fragment, container, false);
    ...
    void implement() {
        p_addMaterialFragment = new P_AddMaterialFragment(getContext(), this);
        ...
        cmb_Provinces.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                try {
                    ...
                    if (item != null) {
                        p_addMaterialFragment.getCities(item.getId());
                    }
    ...
    void setToolbar() {
        ...
        toolbar.setTitle(getContext().getResources().getString(R.string.AddMaterial));
    ...
    public void onResume() {
        ...
        if (enableBankingPortal) {
            ...
            p_addMaterialFragment.getDetailItem();
        }
    }
     ...
     **/
    @Override
    public void getAdTypes(ArrayAdapter<VM_AdTypeMaterial> adTypes) {
    ...
    public void onSelectedFile(VM_FileUploadAnalizeTender val, File file) {
        p_addMaterialFragment.checkValidationFile(file, val);
    }
    ...
    public void onValidFile(VM_FileUploadAnalizeTender val, File file) {
        val.setType(p_addMaterialFragment.getTypeFile(file));
    ...
    public boolean checkValidation() {
        ...
        if (cmb_AdType.getAdapter() != null) {
            if (((VM_AdTypeMaterial) cmb_AdType.getSelectedItem()).getAdType() == AdTypeMaterial.title) {
                isValid = false;
    ...
    @Override
    public VM_PostMaterial getInputUser() {
        VM_PostMaterial model = new VM_PostMaterial();
    ...
    @Override
    public void onDetailData(VM_PostMaterial model) {
        try {

            //نوع اگهی
            if (model.getAdType() != null) {
                cmb_AdType.setSelection(p_addMaterialFragment.getPositionAdType(model.getAdType().getAdType()));
            }
...
//            cmb_City.setSelection(p_addPowerSupply.getPositionCity(model.getCity(), model.getState()));
            positionCitySpinner = p_addMaterialFragment.getPositionCity(model.getCity(), model.getState());
    ...
    void clear2(String val) {
        handler_clear.post(() -> {
            switch (val) {
                case "recycler":
                    p_addMaterialFragment.getDefaultFileUploadValues();
                    break;
    ...
    public void onDestroy() {
        super.onDestroy();
        p_addMaterialFragment.cancel(TAG);
    }
