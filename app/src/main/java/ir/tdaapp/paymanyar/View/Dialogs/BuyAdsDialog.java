...
/**
 * مربوط به دیالوگ خرید تبلیغ
 * **/
public class BuyAdsDialog extends BaseDialogFragment implements View.OnClickListener{

    public final static String TAG = "BuyAdsDialog";

    private VM_Charge charge;
    TextView lbl_Title, lbl_Description, btn_Cancel, btn_Buy;
    ImageView img;

    public BuyAdsDialog(VM_Charge charge) {
        this.charge = charge;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.buy_ads_dialog, container, false);
    ...
    void gotoBuy() {
        ...
        String url = paymentUrl + "PaymentAdvertisingCos/Index?AdvertisingCosId=" + charge.getId() + "&ApiKey=" + api_key;
